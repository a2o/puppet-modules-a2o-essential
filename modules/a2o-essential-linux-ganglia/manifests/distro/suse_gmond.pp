...
### Service: gmond
class   a2o-essential-linux-ganglia::distro::suse_gmond::service   inherits   a2o-essential-linux-ganglia::distro::base_gmond {

    a2o-essential-suse::service::rctool_wrapper { 'gmond':
        require   => $require,
        subscribe => $subscribe,
    }
}
