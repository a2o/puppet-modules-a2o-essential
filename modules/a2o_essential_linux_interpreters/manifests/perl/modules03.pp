...
### Software package: perl modules 03
class   a2o_essential_linux_interpreters::perl::modules03   inherits   a2o_essential_linux_interpreters::perl::base {
    ...
    $softwareName      = "$packageTag_perl-modules03"
    ...
    $require = [
        Package['perl'],
	Package["$packageTag_perl-modules02"],
        Package['mysql'],
    ]
    a2o-essential-unix::compiletool::package::generic { "$packageTag":
	require             => $require,
	installScriptTplUri => "$thisPuppetModule/install-perl-modules03.sh",
    }
