...
### Software package: perl modules 01
class   a2o_essential_linux_interpreters::perl::modules01   inherits   a2o_essential_linux_interpreters::perl::base {
    ...
    $softwareName      = "$packageTag_perl-modules01"
	...
	require             => $require,
	installScriptTplUri => "$thisPuppetModule/install-perl-modules01.sh",
    }
