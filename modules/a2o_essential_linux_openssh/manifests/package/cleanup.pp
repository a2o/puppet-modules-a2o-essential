...
#    a2o-essential-unix::compiletool::package::remove { 'openssh-6.1p1-2': compileDir => $compileDir, require => $require, }
#    a2o-essential-unix::compiletool::package::remove { 'openssh-6.1p2-2': compileDir => $compileDir, require => $require, }
}
