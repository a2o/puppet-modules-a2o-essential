...
### Software package: procps
class   a2o-essential-linux-tools::procps   inherits   a2o-essential-linux-tools::base {

    # Software details
    $packageName            = 'procps'
    $packageSoftware        = 'procps'
    # CheckURI:
    $packageSoftwareVersion = '3.2.8'
    $packageRelease         = '1'
