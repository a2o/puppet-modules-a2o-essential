...
### Software package: psmisc
class   a2o-essential-linux-tools::psmisc   inherits   a2o-essential-linux-tools::base {

    # Software details
    $packageName            = 'psmisc'
    $packageSoftware        = 'psmisc'
    # CheckURI:
    $packageSoftwareVersion = '22.14'
    $packageRelease         = '1'
