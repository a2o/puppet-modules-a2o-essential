...
### Software package: hdparm
class   a2o-essential-linux-tools::hdparm   inherits   a2o-essential-linux-tools::base {

    # Software details
    $packageName            = 'hdparm'
    $packageSoftware        = 'hdparm'
    # CheckURI:
    $packageSoftwareVersion = '9.37'
    $packageRelease         = '1'
