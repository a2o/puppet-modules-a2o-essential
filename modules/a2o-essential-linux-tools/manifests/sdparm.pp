...
### Software package: sdparm
class   a2o-essential-linux-tools::sdparm   inherits   a2o-essential-linux-tools::base {

    # Software details
    $packageName            = 'sdparm'
    $packageSoftware        = 'sdparm'
    # CheckURI:
    $packageSoftwareVersion = '1.06'
    $packageRelease         = '1'
