...
### Software package: latencytop
class   a2o-essential-linux-tools::latencytop   inherits   a2o-essential-linux-tools::base {

    # Software details
    $packageName            = 'latencytop'
    $packageSoftware        = 'latencytop'
    # CheckURI:
    $packageSoftwareVersion = '0.5'
    $packageRelease         = '1'
