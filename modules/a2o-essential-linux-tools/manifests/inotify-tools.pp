...
### Software package: inotify-tools
class   a2o-essential-linux-tools::inotify-tools   inherits   a2o-essential-linux-tools::base {

    # Software details
    $packageName            = 'inotify-tools'
    $packageSoftware        = 'inotify-tools'
    # CheckURI:
    $packageSoftwareVersion = '3.13'
    $packageRelease         = '1'
