...
### Software package: bridge-utils
class   a2o-essential-linux-tools::bridge-utils   inherits   a2o-essential-linux-tools::base {

    # Software details
    $packageName            = 'bridge-utils'
    $packageSoftware        = 'bridge-utils'
    # CheckURI:
    $packageSoftwareVersion = '1.5'
    $packageRelease         = '1'
