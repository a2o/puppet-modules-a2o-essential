...
### Software package: netcat
class   a2o-essential-linux-tools::netcat   inherits   a2o-essential-linux-tools::base {

    # Software details
    $packageName            = 'netcat'
    $packageSoftware        = 'netcat'
    # CheckURI:
    $packageSoftwareVersion = '0.7.1'
    $packageRelease         = '1'
