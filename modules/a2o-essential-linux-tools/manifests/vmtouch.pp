...
### Software package: vmtouch
class   a2o-essential-linux-tools::vmtouch   inherits   a2o-essential-linux-tools::base {

    # Software details
    $packageName            = 'vmtouch'
    $packageSoftware        = 'vmtouch'
    $packageSoftwareVersion = '0.1.0'
    $packageRelease         = '1'
