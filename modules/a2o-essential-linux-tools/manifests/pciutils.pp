...
### Software package: pciutils
class   a2o-essential-linux-tools::pciutils   inherits   a2o-essential-linux-tools::base {

    # Software details
    $packageName            = 'pciutils'
    $packageSoftware        = 'pciutils'
    # CheckURI:
    $packageSoftwareVersion = '3.1.8'
    $packageRelease         = '1'
