...
### Software package: libpcap
class   a2o-essential-linux-libs::libpcap   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'libpcap'
    $packageSoftware        = 'libpcap'
    $packageSoftwareVersion = '1.2.1'
    $packageRelease         = '1'
