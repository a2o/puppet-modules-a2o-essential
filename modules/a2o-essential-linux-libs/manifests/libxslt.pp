...
### Software package: libxslt
class   a2o-essential-linux-libs::libxslt   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'libxslt'
    $packageSoftware        = 'libxslt'
    $packageSoftwareVersion = '1.1.26'
    $packageRelease         = '1'
