...
### Software package: openipmi
class   a2o-essential-linux-libs::openipmi   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'openipmi'
    $packageSoftware        = 'openipmi'
    $packageSoftwareVersion = '2.0.19'
    $packageRelease         = '1'
