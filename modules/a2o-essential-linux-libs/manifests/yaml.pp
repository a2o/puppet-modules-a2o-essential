...
### Software package: yaml
class   a2o-essential-linux-libs::yaml   inherits   a2o-essential-linux-libs::base {

    # Software details
    # CheckURI: http://pyyaml.org/wiki/LibYAML
    $packageName            = 'yaml'
    $packageSoftware        = 'yaml'
    $packageSoftwareVersion = '0.1.4'
    $packageRelease         = '1'
