...
### Software package: gettext
class   a2o-essential-linux-libs::gettext   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'gettext'
    $packageSoftware        = 'gettext'
    $packageSoftwareVersion = '0.18.1.1'
    $packageRelease         = '1'
