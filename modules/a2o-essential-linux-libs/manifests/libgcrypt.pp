...
### Software package: libgcrypt
class   a2o-essential-linux-libs::libgcrypt   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'libgcrypt'
    $packageSoftware        = 'libgcrypt'
    $packageSoftwareVersion = '1.5.0'
    $packageRelease         = '1'
