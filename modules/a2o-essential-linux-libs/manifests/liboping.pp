...
### Software package: liboping
class   a2o-essential-linux-libs::liboping   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'liboping'
    $packageSoftware        = 'liboping'
    $packageSoftwareVersion = '1.6.1'
    $packageRelease         = '1'
