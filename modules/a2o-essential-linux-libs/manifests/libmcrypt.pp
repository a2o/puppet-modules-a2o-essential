...
### Software package: libmcrypt
class   a2o-essential-linux-libs::libmcrypt   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'libmcrypt'
    $packageSoftware        = 'libmcrypt'
    $packageSoftwareVersion = '2.5.8'
    $packageRelease         = '1'
