...
### Software package: libnetfilter-conntrack
class   a2o-essential-linux-libs::libnetfilter-conntrack   inherits   a2o-essential-linux-libs::base {

    # Software details
    # CheckURI: http://www.netfilter.org/projects/libnetfilter_conntrack/downloads.html
    $packageName            = 'libnetfilter-conntrack'
    $packageSoftware        = 'libnetfilter-conntrack'
    $packageSoftwareVersion = '1.0.0'
    $packageRelease         = '1'
