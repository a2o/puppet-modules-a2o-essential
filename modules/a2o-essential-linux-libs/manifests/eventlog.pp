...
### Software package: eventlog
class   a2o-essential-linux-libs::eventlog   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'eventlog'
    $packageSoftware        = 'eventlog'
    $packageSoftwareVersion = '0.2.12'
    $packageRelease         = '1'
