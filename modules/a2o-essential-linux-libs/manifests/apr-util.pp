...
### Software package: apr-util
class   a2o-essential-linux-libs::apr-util   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'apr-util'
    $packageSoftware        = 'apr-util'
    $packageSoftwareVersion = '1.4.1'
    $packageRelease         = '1'
