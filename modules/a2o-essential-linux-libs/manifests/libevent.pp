...
### Software package: libevent
class   a2o-essential-linux-libs::libevent   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'libevent'
    $packageSoftware        = 'libevent'
    $packageSoftwareVersion = '2.0.17'
    $packageRelease         = '1'
