...
### Software package: libnettle
class   a2o-essential-linux-libs::libnettle   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'libnettle'
    $packageSoftware        = 'libnettle'
    $packageSoftwareVersion = '2.4'
    $packageRelease         = '1'
