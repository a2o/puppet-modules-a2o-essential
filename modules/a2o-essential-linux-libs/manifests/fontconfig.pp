...
### Software package: fontconfig
class   a2o-essential-linux-libs::fontconfig   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'fontconfig'
    $packageSoftware        = 'fontconfig'
    $packageSoftwareVersion = '2.8.0'
    $packageRelease         = '1'
