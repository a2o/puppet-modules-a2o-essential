...
### Software package: libmilter
class   a2o-essential-linux-libs::libmilter   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'libmilter'
    $packageSoftware        = 'libmilter'
    $packageSoftwareVersion = '8.14.5'
    $packageRelease         = '1'
