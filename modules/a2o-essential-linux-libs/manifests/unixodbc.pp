...
### Software package: unixodbc
class   a2o-essential-linux-libs::unixodbc   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'unixodbc'
    $packageSoftware        = 'unixodbc'
    $packageSoftwareVersion = '2.3.1'
    $packageRelease         = '1'
