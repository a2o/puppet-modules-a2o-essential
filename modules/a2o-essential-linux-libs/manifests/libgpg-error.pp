...
### Software package: libgpg-error
class   a2o-essential-linux-libs::libgpg-error   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'libgpg-error'
    $packageSoftware        = 'libgpg-error'
    $packageSoftwareVersion = '1.10'
    $packageRelease         = '1'
