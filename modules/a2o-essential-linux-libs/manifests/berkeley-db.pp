...
### Software package: berkeley-db
class   a2o-essential-linux-libs::berkeley-db   inherits   a2o-essential-linux-libs::base {

    # Software details
    $packageName            = 'berkeley-db'
    $packageSoftware        = 'berkeley-db'
    $packageSoftwareVersion = '4.8.30'
    $packageRelease         = '1'
